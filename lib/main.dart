...
void main() async {
  ...
  print (validEmail);
  runApp(MyApp(showLogin: showLogin, validEmail: validEmail,));
...
class MyApp extends StatelessWidget {
  ...
  const MyApp({Key? key, required this.showLogin, required this.validEmail}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetMaterialApp(
        debugShowCheckedModeBanner: false,
        home: showLogin ? HomeScreen(): validEmail ? Login()  :
        Onboarding()
    );
  }
}
