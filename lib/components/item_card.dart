...
class ItemCard extends StatelessWidget {
  ...
  const ItemCard({Key? key,
    required this.product, required this.press }) : super(key: key);
  @override
        ...
        children: [
          Padding(
            ...
            child: Container(padding: EdgeInsets.symmetric(horizontal:6),
              height: 150,width: 150,decoration:  BoxDecoration(color:product.color,
                  borderRadius: BorderRadius.circular(10)),
              child: Image.asset(product.image),),
          ),
          Padding(
            padding: const EdgeInsets.symmetric(vertical:5,horizontal: KDefaultPadding-5),
